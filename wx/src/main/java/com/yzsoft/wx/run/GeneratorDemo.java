...
public class GeneratorDemo {
    private static String author ="easyzzh";//作者名称
    private static String outputDir ="E:\\Demo\\JavaEE\\generatorDemo";//生成的位置
    private static String driver ="org.postgresql.Driver";//驱动，注意版本
    //连接路径,注意修改数据库名称
    private static String url ="jdbc:postgresql://172.16.100.148:5434/raw";
    private static String username ="ssadmin";//数据库用户名
    private static String password ="Lz@2022$#p";//数据库密码
    private static String tablePrefix ="sys_";//数据库表的前缀，如t_user
    private static String [] tables = {"sys_orders","sys_department","sys_permission","sys_refund","sys_role","sys_role_permission","sys_user","sys_user_role"};   //生成的表
    private static String parentPackage = "com.yzsoft.wx";//顶级包结构
    ...
    public static void main(String[] args) {
        ...
        dsConfig.setDbType(DbType.POSTGRE_SQL)  // 设置数据库类型 -- MySQL POSTGRE_SQL
